...
//  FoodTracker
//
//  Created by Marc Hein on 09.07.18.
...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Döner", photo: photo1, rating: 3) else {
        ...
        guard let meal3 = Meal(name: "Nudeln mit Hack", photo: photo3, rating: 5) else {
