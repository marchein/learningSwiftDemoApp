...
//  FoodTracker
//
//  Created by Marc Hein on 08.07.18.
...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        // Set the text field's content to the label's text.
        updateSaveButtonState()
    ...
    @IBAction func cancel(_ sender: Any) {
        // Depending on style of presentation (modal or push presentation), this view controller needs to be dismissed in two differend ways
        ...
        if isPresentingInAddMealMode {
            ...
            fatalError("The MealVieController is not inside a navigation controller.")
        }
    }
